...
$pdf->SetAuthor('StiJSON2TCPDF by Ehsan Varasteh, ehsan.ecc@gmail.com');
$pdf->SetTitle((defined('DOC_TITLE') ? DOC_TITLE : '__DOC_TITLE__'));
$pdf->SetSubject((defined('DOC_SUBJECT') ? DOC_SUBJECT : '__DOC_SUBJECT__'));
...
for components in sticomponents:
    if sticomponents[components]['Ident'] == 'StiText':
        ...
        print('/* Ident: %s ||| Name: \'%s\' */' % (sticomponents[components]['Ident'], sticomponents[components]['Name']))
